...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Type Subprocess Non Interrupt</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see bpmn.BPMNPackage#getTypeSubprocessNonInterrupt()
 * @model
 * @generated
 */
public enum TypeSubprocessNonInterrupt implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Type Subprocess Non Interrupt</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final TypeSubprocessNonInterrupt[] VALUES_ARRAY = new TypeSubprocessNonInterrupt[] { MESSAGE,
			TEMPORARY, SCALABLE, CONDITIONAL, SIGNAL, MULTIPLE, PARALLEL_MULTIPLE, };

	/**
	 * A public read-only list of all the '<em><b>Type Subprocess Non Interrupt</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<TypeSubprocessNonInterrupt> VALUES = Collections
			.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Type Subprocess Non Interrupt</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static TypeSubprocessNonInterrupt get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TypeSubprocessNonInterrupt result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Type Subprocess Non Interrupt</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static TypeSubprocessNonInterrupt getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TypeSubprocessNonInterrupt result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Type Subprocess Non Interrupt</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static TypeSubprocessNonInterrupt get(int value) {
		switch (value) {
		case MESSAGE_VALUE:
			return MESSAGE;
	 ...
	 * @generated
	 */
	private TypeSubprocessNonInterrupt(int value, String name, String literal) {
		this.value = value;
		this.name = name;
