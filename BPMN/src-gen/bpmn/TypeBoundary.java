...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Type Boundary</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see bpmn.BPMNPackage#getTypeBoundary()
 * @model
 * @generated
 */
public enum TypeBoundary implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Type Boundary</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final TypeBoundary[] VALUES_ARRAY = new TypeBoundary[] { MESSAGE, TEMPORARY, SCALABLE, CONDITIONAL,
			ERROR, COMPENSATION, SIGNAL, MULTIPLE, PARALLEL_MULTIPLE, CANCEL, };

	/**
	 * A public read-only list of all the '<em><b>Type Boundary</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<TypeBoundary> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Type Boundary</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static TypeBoundary get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TypeBoundary result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Type Boundary</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static TypeBoundary getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TypeBoundary result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Type Boundary</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static TypeBoundary get(int value) {
		switch (value) {
		case MESSAGE_VALUE:
			return MESSAGE;
	 ...
	 * @generated
	 */
	private TypeBoundary(int value, String name, String literal) {
		this.value = value;
		this.name = name;
