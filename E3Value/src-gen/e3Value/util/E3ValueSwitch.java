...
public class E3ValueSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case E3ValuePackage.COMPOSITE_ACTOR: {
			...
			if (result == null)
				result = caseActor(compositeActor);
			if (result == null)
				result = caseBusinessActor(compositeActor);
			if (result == null)
		...
		case E3ValuePackage.ELEMENTARY_ACTOR: {
			...
			if (result == null)
				result = caseActor(elementaryActor);
			if (result == null)
				result = caseBusinessActor(elementaryActor);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case E3ValuePackage.ACTOR: {
			...
			if (result == null)
				result = caseBusinessActor(actor);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case E3ValuePackage.VALUE_PORT_IN: {
			...
			if (result == null)
				result = caseValuePort(valuePortIn);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case E3ValuePackage.VALUE_PORT_OUT: {
			...
			if (result == null)
				result = caseValuePort(valuePortOut);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case E3ValuePackage.STIMULUS_ELEMENT: {
			...
			if (result == null)
				result = casePortElement(stimulusElement);
			if (result == null)
				result = caseDependencyElement(stimulusElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case E3ValuePackage.START_STIMULUS: {
			...
			if (result == null)
				result = caseStimulusElement(startStimulus);
			if (result == null)
				result = casePortElement(startStimulus);
			if (result == null)
				result = caseDependencyElement(startStimulus);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case E3ValuePackage.END_STIMULUS: {
			...
			if (result == null)
				result = caseStimulusElement(endStimulus);
			if (result == null)
				result = casePortElement(endStimulus);
			if (result == null)
				result = caseDependencyElement(endStimulus);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case E3ValuePackage.MARKET_SEGMENT: {
			...
			if (result == null)
				result = caseBusinessActor(marketSegment);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case E3ValuePackage.RESPONSABILITY_ELEMENT: {
			...
			if (result == null)
				result = casePortElement(responsabilityElement);
			if (result == null)
				result = caseDependencyElement(responsabilityElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case E3ValuePackage.AND_FORK: {
			...
			if (result == null)
				result = caseForkElement(andFork);
			if (result == null)
				result = caseLogicalElement(andFork);
			if (result == null)
				result = caseDependencyElement(andFork);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case E3ValuePackage.AND_JOIN: {
			...
			if (result == null)
				result = caseJoinElement(andJoin);
			if (result == null)
				result = caseLogicalElement(andJoin);
			if (result == null)
				result = caseDependencyElement(andJoin);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case E3ValuePackage.OR_FORK: {
			...
			if (result == null)
				result = caseForkElement(orFork);
			if (result == null)
				result = caseLogicalElement(orFork);
			if (result == null)
				result = caseDependencyElement(orFork);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case E3ValuePackage.OR_JOIN: {
			...
			if (result == null)
				result = caseJoinElement(orJoin);
			if (result == null)
				result = caseLogicalElement(orJoin);
			if (result == null)
				result = caseDependencyElement(orJoin);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case E3ValuePackage.FORK_ELEMENT: {
			...
			if (result == null)
				result = caseLogicalElement(forkElement);
			if (result == null)
				result = caseDependencyElement(forkElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case E3ValuePackage.JOIN_ELEMENT: {
			...
			if (result == null)
				result = caseLogicalElement(joinElement);
			if (result == null)
				result = caseDependencyElement(joinElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case E3ValuePackage.CONNECTION_ELEMENT: {
			...
			if (result == null)
				result = caseDependencyElement(connectionElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case E3ValuePackage.PORT_ELEMENT: {
			...
			if (result == null)
				result = caseDependencyElement(portElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case E3ValuePackage.LOGICAL_ELEMENT: {
			...
			if (result == null)
				result = caseDependencyElement(logicalElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case E3ValuePackage.OUTPUT_PORT: {
			...
			if (result == null)
				result = casePortElement(outputPort);
			if (result == null)
				result = caseDependencyElement(outputPort);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case E3ValuePackage.INPUT_PORT: {
			...
			if (result == null)
				result = casePortElement(inputPort);
			if (result == null)
				result = caseDependencyElement(inputPort);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
