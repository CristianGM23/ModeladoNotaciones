			...
			if (targetDependenceElement != oldTargetDependenceElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							E3ValuePackage.CONNECTION_ELEMENT__TARGET_DEPENDENCE_ELEMENT, oldTargetDependenceElement,
							targetDependenceElement));
			}
		}
	...
	public PortElement getSourceDependenceElement() {
		if (sourceDependenceElement != null && sourceDependenceElement.eIsProxy()) {
			...
			if (sourceDependenceElement != oldSourceDependenceElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							E3ValuePackage.CONNECTION_ELEMENT__SOURCE_DEPENDENCE_ELEMENT, oldSourceDependenceElement,
							sourceDependenceElement));
			}
		}
