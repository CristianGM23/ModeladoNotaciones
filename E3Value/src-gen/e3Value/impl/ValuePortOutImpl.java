...
public class ValuePortOutImpl extends ValuePortImpl implements ValuePortOut {
			...
			if (outConnectWithValueExchange != oldOutConnectWithValueExchange) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							E3ValuePackage.VALUE_PORT_OUT__OUT_CONNECT_WITH_VALUE_EXCHANGE,
							oldOutConnectWithValueExchange, outConnectWithValueExchange));
			}
		}
	...
	public void setOutConnectWithValueExchange(ValueExchange newOutConnectWithValueExchange) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					E3ValuePackage.VALUE_PORT_OUT__OUT_CONNECT_WITH_VALUE_EXCHANGE, oldOutConnectWithValueExchange,
					outConnectWithValueExchange));
	}
	...
	public void setPositionValuePort(Position newPositionValuePort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, E3ValuePackage.VALUE_PORT_OUT__POSITION_VALUE_PORT,
					oldPositionValuePort, positionValuePort));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case E3ValuePackage.VALUE_PORT_OUT__OUT_CONNECT_WITH_VALUE_EXCHANGE:
			if (resolve)
				return getOutConnectWithValueExchange();
