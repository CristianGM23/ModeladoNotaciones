...
public class JoinElementImpl extends LogicalElementImpl implements JoinElement {
	...
	public EList<InputPort> getHasInputsPort() {
		if (hasInputsPort == null) {
			hasInputsPort = new EObjectContainmentEList<InputPort>(InputPort.class, this,
					E3ValuePackage.JOIN_ELEMENT__HAS_INPUTS_PORT);
		}
	...
	public NotificationChain basicSetHasOutputPort(OutputPort newHasOutputPort, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					E3ValuePackage.JOIN_ELEMENT__HAS_OUTPUT_PORT, oldHasOutputPort, newHasOutputPort);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setHasOutputPort(OutputPort newHasOutputPort) {
		if (newHasOutputPort != hasOutputPort) {
			...
			if (hasOutputPort != null)
				msgs = ((InternalEObject) hasOutputPort).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - E3ValuePackage.JOIN_ELEMENT__HAS_OUTPUT_PORT, null, msgs);
			if (newHasOutputPort != null)
				msgs = ((InternalEObject) newHasOutputPort).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - E3ValuePackage.JOIN_ELEMENT__HAS_OUTPUT_PORT, null, msgs);
			msgs = basicSetHasOutputPort(newHasOutputPort, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, E3ValuePackage.JOIN_ELEMENT__HAS_OUTPUT_PORT,
					newHasOutputPort, newHasOutputPort));
	}
	...
	public void setPositionJoin(Orientation newPositionJoin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, E3ValuePackage.JOIN_ELEMENT__POSITION_JOIN,
					oldPositionJoin, positionJoin));
	}
