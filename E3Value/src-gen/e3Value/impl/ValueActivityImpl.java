...
public class ValueActivityImpl extends MinimalEObjectImpl.Container implements ValueActivity {
	...
	public EList<StimulusElement> getHasStimulusElement() {
		if (hasStimulusElement == null) {
			hasStimulusElement = new EObjectResolvingEList<StimulusElement>(StimulusElement.class, this,
					E3ValuePackage.VALUE_ACTIVITY__HAS_STIMULUS_ELEMENT);
		}
	...
	public EList<DependencyElement> getHasDependenceElements() {
		if (hasDependenceElements == null) {
			hasDependenceElements = new EObjectContainmentEList<DependencyElement>(DependencyElement.class, this,
					E3ValuePackage.VALUE_ACTIVITY__HAS_DEPENDENCE_ELEMENTS);
		}
	...
	public EList<ValueInterface> getValueinterfaces() {
		if (valueinterfaces == null) {
			valueinterfaces = new EObjectContainmentEList<ValueInterface>(ValueInterface.class, this,
					E3ValuePackage.VALUE_ACTIVITY__VALUEINTERFACES);
		}
