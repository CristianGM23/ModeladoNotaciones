...
public class ValuePortInImpl extends ValuePortImpl implements ValuePortIn {
			...
			if (inConnectWithValueExchange != oldInConnectWithValueExchange) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							E3ValuePackage.VALUE_PORT_IN__IN_CONNECT_WITH_VALUE_EXCHANGE, oldInConnectWithValueExchange,
							inConnectWithValueExchange));
			}
		}
	...
	public void setPositionValuePort(Position newPositionValuePort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, E3ValuePackage.VALUE_PORT_IN__POSITION_VALUE_PORT,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case E3ValuePackage.VALUE_PORT_IN__IN_CONNECT_WITH_VALUE_EXCHANGE:
			if (resolve)
				return getInConnectWithValueExchange();
