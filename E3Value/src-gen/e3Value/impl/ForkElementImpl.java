...
public class ForkElementImpl extends LogicalElementImpl implements ForkElement {
	...
	public EList<OutputPort> getHasOutputsPort() {
		if (hasOutputsPort == null) {
			hasOutputsPort = new EObjectContainmentEList<OutputPort>(OutputPort.class, this,
					E3ValuePackage.FORK_ELEMENT__HAS_OUTPUTS_PORT);
		}
	...
	public NotificationChain basicSetHasInputPort(InputPort newHasInputPort, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					E3ValuePackage.FORK_ELEMENT__HAS_INPUT_PORT, oldHasInputPort, newHasInputPort);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setHasInputPort(InputPort newHasInputPort) {
		if (newHasInputPort != hasInputPort) {
			...
			if (hasInputPort != null)
				msgs = ((InternalEObject) hasInputPort).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - E3ValuePackage.FORK_ELEMENT__HAS_INPUT_PORT, null, msgs);
			if (newHasInputPort != null)
				msgs = ((InternalEObject) newHasInputPort).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - E3ValuePackage.FORK_ELEMENT__HAS_INPUT_PORT, null, msgs);
			msgs = basicSetHasInputPort(newHasInputPort, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, E3ValuePackage.FORK_ELEMENT__HAS_INPUT_PORT,
					newHasInputPort, newHasInputPort));
	}
	...
	public void setPositionFork(Position newPositionFork) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, E3ValuePackage.FORK_ELEMENT__POSITION_FORK,
					oldPositionFork, positionFork));
	}
