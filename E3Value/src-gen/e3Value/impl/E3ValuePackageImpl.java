...
public class E3ValuePackageImpl extends EPackageImpl implements E3ValuePackage {
	...
	public static E3ValuePackage init() {
		if (isInited)
			return (E3ValuePackage) EPackage.Registry.INSTANCE.getEPackage(E3ValuePackage.eNS_URI);

		// Obtain or create and register package
		E3ValuePackageImpl theE3ValuePackage = (E3ValuePackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof E3ValuePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
						: new E3ValuePackageImpl());
	...
	public void initializePackageContents() {
		...
		initEClass(compositeActorEClass, CompositeActor.class, "CompositeActor", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCompositeActor_HasElementaryActors(), this.getElementaryActor(), null, "hasElementaryActors",
				null, 0, -1, CompositeActor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(elementaryActorEClass, ElementaryActor.class, "ElementaryActor", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(actorEClass, Actor.class, "Actor", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(e3ValueDiagramEClass, E3ValueDiagram.class, "E3ValueDiagram", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getE3ValueDiagram_HasE3ValueModels(), this.getE3ValueModel(), null, "hasE3ValueModels", null, 0,
				-1, E3ValueDiagram.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(e3ValueModelEClass, E3ValueModel.class, "E3ValueModel", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getE3ValueModel_HasValueExchanges(), this.getValueExchange(), null, "hasValueExchanges", null, 0,
				-1, E3ValueModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getE3ValueModel_HasValueObjects(), this.getValueObject(), null, "hasValueObjects", null, 0, -1,
				E3ValueModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getE3ValueModel_HasBusinessActors(), this.getBusinessActor(), null, "hasBusinessActors", null, 0,
				-1, E3ValueModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getE3ValueModel_HasDependenceElements(), this.getDependencyElement(), null,
				"hasDependenceElements", null, 0, -1, E3ValueModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
		...
		initEReference(getValueObject_InValueExchange(), this.getValueExchange(), null, "inValueExchange", null, 1, 1,
				ValueObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(valueExchangeEClass, ValueExchange.class, "ValueExchange", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getValueExchange_TargetValuePort(), this.getValuePort(), null, "targetValuePort", null, 0, 1,
				ValueExchange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getValueExchange_SourceValuePort(), this.getValuePort(), null, "sourceValuePort", null, 0, 1,
				ValueExchange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getValueExchange_HasValueObject(), this.getValueObject(), null, "hasValueObject", null, 1, 1,
				ValueExchange.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(valueInterfaceEClass, ValueInterface.class, "ValueInterface", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getValueInterface_BindsResponsabilityElement(), this.getResponsabilityElement(), null,
				"bindsResponsabilityElement", null, 1, 1, ValueInterface.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getValueInterface_HasValuePortOut(), this.getValuePortOut(), null, "hasValuePortOut", null, 1, 1,
				ValueInterface.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getValueInterface_HasValuePortIn(), this.getValuePortIn(), null, "hasValuePortIn", null, 1, 1,
				ValueInterface.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(valuePortInEClass, ValuePortIn.class, "ValuePortIn", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getValuePortIn_InConnectWithValueExchange(), this.getValueExchange(), null,
				"inConnectWithValueExchange", null, 0, 1, ValuePortIn.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getValuePortIn_PositionValuePort(), this.getPosition(), "positionValuePort", null, 0, 1,
				ValuePortIn.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(valuePortOutEClass, ValuePortOut.class, "ValuePortOut", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getValuePortOut_OutConnectWithValueExchange(), this.getValueExchange(), null,
				"outConnectWithValueExchange", null, 0, 1, ValuePortOut.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getValuePortOut_PositionValuePort(), this.getPosition(), "positionValuePort", null, 0, 1,
				ValuePortOut.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(stimulusElementEClass, StimulusElement.class, "StimulusElement", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(startStimulusEClass, StartStimulus.class, "StartStimulus", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(endStimulusEClass, EndStimulus.class, "EndStimulus", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(valueActivityEClass, ValueActivity.class, "ValueActivity", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getValueActivity_Name(), ecorePackage.getEString(), "name", null, 0, 1, ValueActivity.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getValueActivity_HasStimulusElement(), this.getStimulusElement(), null, "hasStimulusElement",
				null, 0, -1, ValueActivity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getValueActivity_HasDependenceElements(), this.getDependencyElement(), null,
				"hasDependenceElements", null, 0, -1, ValueActivity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getValueActivity_Valueinterfaces(), this.getValueInterface(), null, "valueinterfaces", null, 0,
				-1, ValueActivity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(marketSegmentEClass, MarketSegment.class, "MarketSegment", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(businessActorEClass, BusinessActor.class, "BusinessActor", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBusinessActor_Name(), ecorePackage.getEString(), "name", null, 0, 1, BusinessActor.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBusinessActor_HasDependenceElements(), this.getDependencyElement(), null,
				"hasDependenceElements", null, 0, -1, BusinessActor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBusinessActor_HasStimulusElement(), this.getStimulusElement(), null, "hasStimulusElement",
				null, 0, -1, BusinessActor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBusinessActor_HasValuesInterface(), this.getValueInterface(), null, "hasValuesInterface",
				null, 0, -1, BusinessActor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBusinessActor_HasValueObjects(), this.getValueObject(), null, "hasValueObjects", null, 0, -1,
				BusinessActor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBusinessActor_HasValueActivities(), this.getValueActivity(), null, "hasValueActivities", null,
				0, -1, BusinessActor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(valuePortEClass, ValuePort.class, "ValuePort", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getValuePort_Valueexchange(), this.getValueExchange(), null, "valueexchange", null, 0, -1,
				ValuePort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(responsabilityElementEClass, ResponsabilityElement.class, "ResponsabilityElement", !IS_ABSTRACT,
		...
		initEClass(forkElementEClass, ForkElement.class, "ForkElement", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getForkElement_HasOutputsPort(), this.getOutputPort(), null, "hasOutputsPort", null, 0, -1,
				ForkElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getForkElement_HasInputPort(), this.getInputPort(), null, "hasInputPort", null, 0, 1,
				ForkElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getForkElement_PositionFork(), this.getPosition(), "positionFork", null, 0, 1, ForkElement.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(joinElementEClass, JoinElement.class, "JoinElement", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getJoinElement_HasInputsPort(), this.getInputPort(), null, "hasInputsPort", null, 0, -1,
				JoinElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getJoinElement_HasOutputPort(), this.getOutputPort(), null, "hasOutputPort", null, 0, 1,
				JoinElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getJoinElement_PositionJoin(), this.getOrientation(), "positionJoin", null, 0, 1,
				JoinElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(connectionElementEClass, ConnectionElement.class, "ConnectionElement", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getConnectionElement_TargetDependenceElement(), this.getPortElement(), null,
				"targetDependenceElement", null, 1, 1, ConnectionElement.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getConnectionElement_SourceDependenceElement(), this.getPortElement(), null,
				"sourceDependenceElement", null, 1, 1, ConnectionElement.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(portElementEClass, PortElement.class, "PortElement", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPortElement_Connectionelement(), this.getConnectionElement(), null, "connectionelement", null,
				0, -1, PortElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(dependencyElementEClass, DependencyElement.class, "DependencyElement", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(logicalElementEClass, LogicalElement.class, "LogicalElement", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
