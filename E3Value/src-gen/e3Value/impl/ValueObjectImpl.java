...
public class ValueObjectImpl extends MinimalEObjectImpl.Container implements ValueObject {
			...
			if (inValueExchange != oldInValueExchange) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							E3ValuePackage.VALUE_OBJECT__IN_VALUE_EXCHANGE, oldInValueExchange, inValueExchange));
			}
		}
	...
	public void setInValueExchange(ValueExchange newInValueExchange) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, E3ValuePackage.VALUE_OBJECT__IN_VALUE_EXCHANGE,
					oldInValueExchange, inValueExchange));
	}
