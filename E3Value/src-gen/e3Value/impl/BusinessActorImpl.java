...
public class BusinessActorImpl extends MinimalEObjectImpl.Container implements BusinessActor {
	...
	public EList<DependencyElement> getHasDependenceElements() {
		if (hasDependenceElements == null) {
			hasDependenceElements = new EObjectContainmentEList<DependencyElement>(DependencyElement.class, this,
					E3ValuePackage.BUSINESS_ACTOR__HAS_DEPENDENCE_ELEMENTS);
		}
	...
	public EList<StimulusElement> getHasStimulusElement() {
		if (hasStimulusElement == null) {
			hasStimulusElement = new EObjectContainmentEList<StimulusElement>(StimulusElement.class, this,
					E3ValuePackage.BUSINESS_ACTOR__HAS_STIMULUS_ELEMENT);
		}
	...
	public EList<ValueInterface> getHasValuesInterface() {
		if (hasValuesInterface == null) {
			hasValuesInterface = new EObjectContainmentEList<ValueInterface>(ValueInterface.class, this,
					E3ValuePackage.BUSINESS_ACTOR__HAS_VALUES_INTERFACE);
		}
	...
	public EList<ValueObject> getHasValueObjects() {
		if (hasValueObjects == null) {
			hasValueObjects = new EObjectContainmentEList<ValueObject>(ValueObject.class, this,
					E3ValuePackage.BUSINESS_ACTOR__HAS_VALUE_OBJECTS);
		}
	...
	public EList<ValueActivity> getHasValueActivities() {
		if (hasValueActivities == null) {
			hasValueActivities = new EObjectContainmentEList<ValueActivity>(ValueActivity.class, this,
					E3ValuePackage.BUSINESS_ACTOR__HAS_VALUE_ACTIVITIES);
		}
