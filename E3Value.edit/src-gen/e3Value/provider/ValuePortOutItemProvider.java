...
public class ValuePortOutItemProvider extends ValuePortItemProvider {
	...
	protected void addOutConnectWithValueExchangePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ValuePortOut_outConnectWithValueExchange_feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_ValuePortOut_outConnectWithValueExchange_feature", "_UI_ValuePortOut_type"),
						E3ValuePackage.Literals.VALUE_PORT_OUT__OUT_CONNECT_WITH_VALUE_EXCHANGE, true, false, true,
						null, null, null));
	}
	...
	protected void addPositionValuePortPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ValuePortOut_positionValuePort_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ValuePortOut_positionValuePort_feature",
								"_UI_ValuePortOut_type"),
						E3ValuePackage.Literals.VALUE_PORT_OUT__POSITION_VALUE_PORT, true, false, false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ValuePortOut_type")
