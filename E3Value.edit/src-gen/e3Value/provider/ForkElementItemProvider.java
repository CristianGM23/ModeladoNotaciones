...
public class ForkElementItemProvider extends LogicalElementItemProvider {
	...
	protected void addPositionForkPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ForkElement_positionFork_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ForkElement_positionFork_feature",
								"_UI_ForkElement_type"),
						E3ValuePackage.Literals.FORK_ELEMENT__POSITION_FORK, true, false, false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ForkElement_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(E3ValuePackage.Literals.FORK_ELEMENT__HAS_OUTPUTS_PORT,
				E3ValueFactory.eINSTANCE.createOutputPort()));

		newChildDescriptors.add(createChildParameter(E3ValuePackage.Literals.FORK_ELEMENT__HAS_INPUT_PORT,
