 ...
 * @generated
 */
public class ValueActivityItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ValueActivity_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ValueActivity_name_feature",
								"_UI_ValueActivity_type"),
						E3ValuePackage.Literals.VALUE_ACTIVITY__NAME, true, false, false,
	...
	protected void addHasStimulusElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ValueActivity_hasStimulusElement_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ValueActivity_hasStimulusElement_feature",
								"_UI_ValueActivity_type"),
						E3ValuePackage.Literals.VALUE_ACTIVITY__HAS_STIMULUS_ELEMENT, true, false, true, null, null,
						null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ValueActivity_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(E3ValuePackage.Literals.VALUE_ACTIVITY__HAS_DEPENDENCE_ELEMENTS,
		...
		newChildDescriptors.add(createChildParameter(E3ValuePackage.Literals.VALUE_ACTIVITY__VALUEINTERFACES,
