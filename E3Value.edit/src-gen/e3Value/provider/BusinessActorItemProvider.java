 ...
 * @generated
 */
public class BusinessActorItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_BusinessActor_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_BusinessActor_name_feature",
								"_UI_BusinessActor_type"),
						E3ValuePackage.Literals.BUSINESS_ACTOR__NAME, true, false, false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_BusinessActor_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(E3ValuePackage.Literals.BUSINESS_ACTOR__HAS_DEPENDENCE_ELEMENTS,
		...
		newChildDescriptors.add(createChildParameter(E3ValuePackage.Literals.BUSINESS_ACTOR__HAS_STIMULUS_ELEMENT,
				E3ValueFactory.eINSTANCE.createStimulusElement()));
		...
		newChildDescriptors.add(createChildParameter(E3ValuePackage.Literals.BUSINESS_ACTOR__HAS_VALUES_INTERFACE,
				E3ValueFactory.eINSTANCE.createValueInterface()));

		newChildDescriptors.add(createChildParameter(E3ValuePackage.Literals.BUSINESS_ACTOR__HAS_VALUE_OBJECTS,
				E3ValueFactory.eINSTANCE.createValueObject()));

		newChildDescriptors.add(createChildParameter(E3ValuePackage.Literals.BUSINESS_ACTOR__HAS_VALUE_ACTIVITIES,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == E3ValuePackage.Literals.BUSINESS_ACTOR__HAS_DEPENDENCE_ELEMENTS
