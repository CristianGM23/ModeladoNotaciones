...
public class JoinElementItemProvider extends LogicalElementItemProvider {
	...
	protected void addPositionJoinPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_JoinElement_positionJoin_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_JoinElement_positionJoin_feature",
								"_UI_JoinElement_type"),
						E3ValuePackage.Literals.JOIN_ELEMENT__POSITION_JOIN, true, false, false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_JoinElement_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(E3ValuePackage.Literals.JOIN_ELEMENT__HAS_INPUTS_PORT,
				E3ValueFactory.eINSTANCE.createInputPort()));

		newChildDescriptors.add(createChildParameter(E3ValuePackage.Literals.JOIN_ELEMENT__HAS_OUTPUT_PORT,
