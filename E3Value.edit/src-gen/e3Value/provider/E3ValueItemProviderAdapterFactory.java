 ...
 * @generated
 */
public class E3ValueItemProviderAdapterFactory extends E3ValueAdapterFactory
	...
	public void dispose() {
		...
		if (elementaryActorItemProvider != null)
			elementaryActorItemProvider.dispose();
		if (actorItemProvider != null)
			actorItemProvider.dispose();
		if (e3ValueDiagramItemProvider != null)
			e3ValueDiagramItemProvider.dispose();
		if (e3ValueModelItemProvider != null)
			e3ValueModelItemProvider.dispose();
		if (valueObjectItemProvider != null)
			valueObjectItemProvider.dispose();
		if (valueExchangeItemProvider != null)
			valueExchangeItemProvider.dispose();
		if (valueInterfaceItemProvider != null)
			valueInterfaceItemProvider.dispose();
		if (valuePortInItemProvider != null)
			valuePortInItemProvider.dispose();
		if (valuePortOutItemProvider != null)
			valuePortOutItemProvider.dispose();
		if (stimulusElementItemProvider != null)
			stimulusElementItemProvider.dispose();
		if (startStimulusItemProvider != null)
			startStimulusItemProvider.dispose();
		if (endStimulusItemProvider != null)
			endStimulusItemProvider.dispose();
		if (valueActivityItemProvider != null)
			valueActivityItemProvider.dispose();
		if (marketSegmentItemProvider != null)
			marketSegmentItemProvider.dispose();
		if (businessActorItemProvider != null)
			businessActorItemProvider.dispose();
		if (valuePortItemProvider != null)
			valuePortItemProvider.dispose();
		if (responsabilityElementItemProvider != null)
			responsabilityElementItemProvider.dispose();
		if (andForkItemProvider != null)
			andForkItemProvider.dispose();
		if (andJoinItemProvider != null)
			andJoinItemProvider.dispose();
		if (orForkItemProvider != null)
			orForkItemProvider.dispose();
		if (orJoinItemProvider != null)
			orJoinItemProvider.dispose();
		if (forkElementItemProvider != null)
			forkElementItemProvider.dispose();
		if (joinElementItemProvider != null)
			joinElementItemProvider.dispose();
		if (connectionElementItemProvider != null)
			connectionElementItemProvider.dispose();
		if (portElementItemProvider != null)
			portElementItemProvider.dispose();
		if (dependencyElementItemProvider != null)
			dependencyElementItemProvider.dispose();
		if (logicalElementItemProvider != null)
			logicalElementItemProvider.dispose();
		if (outputPortItemProvider != null)
