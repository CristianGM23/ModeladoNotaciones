 ...
 * @generated
 */
public class GatewayItemProvider extends ElementsItemProvider {
	/**
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Gateway_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Gateway_type_feature", "_UI_Gateway_type"),
						BPMNPackage.Literals.GATEWAY__TYPE, true, false, false,
	...
	public void notifyChanged(Notification notification) {
		...
		case BPMNPackage.GATEWAY__TYPE:
