 ...
 * @generated
 */
public class EventItemProvider extends ElementsItemProvider {
	/**
	...
	protected void addActivityPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Event_activity_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Event_activity_feature", "_UI_Event_type"),
						BPMNPackage.Literals.EVENT__ACTIVITY, true, false, true, null, null, null));
	}
